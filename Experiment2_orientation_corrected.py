...
def single_estimation(figure, r, res, noise_seq, noise_random, rh,
    ...
    for noise in noise_seq:
        ...
        if figure=="cylinder" or figure=="sphere" or figure == "sphere_hole":
            ...
            #For every point on the noisy sphere we will assign the normal
            #of its closest point in the smooth surface. That way we assign
            #the "true normals" to the noisy surfaces.
            ...
            for v in tg.graph.vertices():
                ...
                #surf the true normal it should have.
        ...
        subfold = "Experiment2_orientation_corrected/" +figure + "/ParaViewFiles/"
        ...
        if df_generate:
            ...
            subfold = "Experiment2_orientation_corrected/" +figure+"/CSVFiles/" 
            subsubfold = noise_direction +"Noise/"+ method + "/" + "res"+ str(res)+"/" + "noise"+str(noise) + "/r" + str(r)+"/"
    ...
    #Set folders to save the files
    subfold = "Experiment2_orientation_corrected/" +figure+"/CSVFiles/average_errors/noise_seq/"
    ...
    for method_chosen in methods_list:        
        for noise_random in noise_random_direction:
            ...
            for i, res in enumerate(res_levels):
                ...
                path = f"Experiment2_orientation_corrected/{geometry}/CSVFiles/average_errors/noise_seq/"
                filename=f"average_errors_r{r}_method{method_chosen}_rh{rh}_res{res}_random{noise_random}.csv"
            ...
            subfold = "Experiment2_orientation_corrected_figs/"

            if os.path.isdir(subfold) == False:
                os.makedirs(subfold)

            fig.savefig(f"Experiment2_orientation_corrected_figs/{geometry}_noise_average_{method_chosen}_noiserandom{noise_random}.png", dpi=300)
