...
def single_estimation(figure, r, res_seq, noise, noise_random, rh,
    ...
    for res in res_seq:
        ...
        subfold = "Experiment1/" + figure + "/ParaViewFiles/" 
        ...
        if df_generate:
            ...
            #Set folders to save the files
            subfold = "Experiment1/" + figure+"/CSVFiles/"
            subsubfold = noise_direction +"Noise/"+ method + "/" + "res"+ str(res)+"/" + "noise"+str(noise) + "/r" + str(r)+"/"
    ...
    #Set folders to save the files
    subfold = "Experiment1/"+figure+"/CSVFiles/average_errors/res_seq/"
    ...
    for method_chosen in methods_list:
        for noise_random in noise_random_direction:
            ...
            for i, noise in enumerate(noise_seq):
                ...
                path = f"Experiment1/{geometry}/CSVFiles/average_errors/res_seq/"
            ...
            subfold = "Experiment1_figs/"

            if os.path.isdir(subfold) == False:
                os.makedirs(subfold)

            fig.savefig(f"Experiment1_figs/{geometry}_resolution_average_{method_chosen}_noiserandom{noise_random}.png", dpi=300)
